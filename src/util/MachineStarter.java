...
public class MachineStarter {
    ...
    private StateMachine initNumberMachine() {
        ...
        ruleSet.addRule(stateC, new ClassifiedSymbol('0'), stateA);
        ruleSet.addRule(stateC, new ClassifiedSymbol('1'), stateD);
        ...
        ruleSet.addRule(stateH, new ClassifiedSymbol('0'), stateFFin);
